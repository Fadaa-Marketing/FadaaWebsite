      ...
      <div className="w-full lg:flex-1 order-1 lg:order-2 flex justify-center items-center px-4 lg:px-0  ">
        <div
          className={`text-white text-center ${
            locale === "ar" ? "lg:text-end" : "lg:text-left"
          }  w-full max-w-[600px] lg:max-w-none lg:sticky lg:top-0 lg:h-screen flex justify-center items-center flex-col lg:mr-14 xl:mr-28`}
        >
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            <span className="main-title-paragraph block">{t("kicker")}</span>
            <h2 className="secondary-title w-full lg:w-full mb-4 sm:mb-6">
              {t("title")}
            </h2>
            ...
            <div className="flex justify-center lg:justify-start pt-4 sm:pt-6">
              <CustomButton link="/about" text={t("button")} />
            </div>
          </div>
        </div>
      </div>
