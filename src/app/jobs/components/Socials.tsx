...
const Socials: React.FC<SocialsProps> = ({ socialImages, socialData }) => {
  return (
    <section className="main-padding flex flex-col lg:flex-row items-start justify-between gap-12">
      ...
      <div className="flex flex-col justify-between w-full lg:w-1/2 gap-10">
        <h2 className="secondary-title text-3xl sm:text-4xl lg:text-5xl leading-tight">
          ...
          <span className="text-secondary">what we're up to!</span>
        </h2>
      ...
      {/* Right Side */}
        ...
        <Image src={'/jobs/team/3.jpeg'} alt='team' width={611} height={284} className='rounded-[20px] w-full h-[284px] object-cover' />
        <div className='grid grid-cols-2 gap-4'>
            <div className='flex flex-col items-center'>
                <Image src={'/jobs/team/1.jpeg'} alt='team' width={200} height={200} className='rounded-[20px] w-full h-[200px] object-cover' />

            </div>
            <div className='flex flex-col items-center'>
                <Image src={'/jobs/team/2.jpeg'} alt='team' width={200} height={200} className='rounded-[20px] w-full h-[200px] object-cover' />
            </div>
        </div>
      </div>
    </section>
